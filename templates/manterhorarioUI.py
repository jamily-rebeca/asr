...
class ManterHorarioUI:
    ...
    def listar():
        ...
        if len(horarios) == 0: 
            ...
            for obj in horarios:
                ...
                dic.append({"id" : obj.get_idHorario(), "data" : obj.get_horario_str(), "confirmado" : obj.get_confirmado(), "cliente" : cliente, "serviço" : servico})
    ...
    def inserir():
        ...
        if st.button("Inserir"):
            id_cliente = None
            id_servico = None
            if cliente != None: id_cliente = cliente.get_idCliente()
            if servico != None: id_servico = servico.get_idServico()
    ...
    def atualizar():
        ...
        if len(horarios) == 0: 
            ...
            data = st.text_input("Informe a nova data e horário do serviço", op.get_data_str())
